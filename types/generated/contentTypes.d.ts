...
export interface PluginAuthzeroAdminLoginAuthzeroAdminLoginConfiguration
...
export interface ApiFundCollectionFundCollection extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'plugin::authzero-admin-login.authzero-admin-login-configuration': PluginAuthzeroAdminLoginAuthzeroAdminLoginConfiguration;
